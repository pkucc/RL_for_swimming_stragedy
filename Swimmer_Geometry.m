...
N = 128;                            % # of Cartesian grid meshwidths
...
% print springs
k_Spring = 7.5*1.2750000000000000e+8;        % spring constant (Newton)
print_Lagrangian_Springs(xLag,k_Spring,ds,struct_name);

% print beams
k_Beam = 2.0363359375000002e+10;   % beam stiffness constant (Newton m^2)
